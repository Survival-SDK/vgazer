...
def Install(auth, software, platform, platformData, mirrors, verbose):
    ...
    try:
        releases = auth["github"].GetJson(
         "https://api.github.com/repos/CMakePorts/libp7-baical/releases")
    except ConnectionError:
        print("VGAZER: Unable to know last version of", software)
        raise InstallError(software + " not installed")

    with GithubApiErrorMgr(releases, "CMakePorts/libp7-baical") as errMgr:
        ...
        with WorkingDir(buildDir):
            RunCommand(
             ["cmake", "..",
              ...
              "-DCMAKE_VERBOSE_MAKEFILE:BOOL=ON", "-DBUILD_SHARED_LIBS=ON",
